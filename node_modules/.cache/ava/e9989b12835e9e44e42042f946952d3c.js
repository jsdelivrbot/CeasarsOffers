...
var dbUtilsMock = {
    ...
    buildContactInsertStatementFromFile(a, b) {}
};

myModule.__set__("caesarsLogger", caesarsLoggerMock);

(0, _ava2.default)('get contacts', t => {
    myModule.getContacts(null, null, null);
    t.true(true);
});

(0, _ava2.default)('get Records Before Date And Post To FTP Server', t => {
    myModule.getRecordsBeforeDateAndPostToFTPServer(null, null, new function (a, b, c) {}());
    t.true(true);
});

(0, _ava2.default)('post Contact', t => {
    myModule.postContact(null, null, null);
    t.true(true);
});

(0, _ava2.default)('upload Contacts', t => {
    myModule.uploadContacts(null);
    t.true(true);
});
//# sourceMappingURL=..\node_modules\.cache\ava\e9989b12835e9e44e42042f946952d3c.js.map