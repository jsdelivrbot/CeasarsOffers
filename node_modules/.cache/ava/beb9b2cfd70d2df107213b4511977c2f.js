...
(0, _ava2.default)('add customer Info', t => {
				myModule.addCustomerInfo(null, null, null);
				t.true(true);
});

(0, _ava2.default)('get customers', t => {
				myModule.getCustomers(null, null, null);
				t.true(true);
});

(0, _ava2.default)('build Customer Query Statement', t => {

				let requestParameters = new Map();
				...
				t.equals(statement, 'SELECT id, data FROM CustomerInfo WHERE id = 1 AND data->>\'firstName\' = \'Mickey\'');
});
//# sourceMappingURL=..\node_modules\.cache\ava\beb9b2cfd70d2df107213b4511977c2f.js.map