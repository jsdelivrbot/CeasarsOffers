...
(0, _ava2.default)('convert date to psql string', t => {
  var d = new Date(2017, 0, 1, 0, 0, 0, 0);
  t.is(dateUtils.convertToPostgresDateTime(d), '2017-01-01 00:00:00');
});

(0, _ava2.default)('ensure leading zeros', t => {
  t.is(dateUtils.ensureLeadingZeros(1), '01');
  t.is(dateUtils.ensureLeadingZeros(10), '10');
});

(0, _ava2.default)('calculate Time Difference In Milliseconds', t => {
  var _rec = new _powerAssertRecorder();

  var startMs = new Date().getTime() - 10;
  t.true(_rec._expr(_rec._capt(_rec._capt(_rec._capt(dateUtils, 'arguments/0/left/callee/object').calculateTimeDiffInMilliseconds(_rec._capt(startMs, 'arguments/0/left/arguments/0')), 'arguments/0/left') >= 10, 'arguments/0'), {
    content: 't.true(dateUtils.calculateTimeDiffInMilliseconds(startMs) >= 10)',
    filepath: 'tests\\dateUtils.js',
    line: 17,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"BinaryExpression","operator":">=","left":{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"dateUtils","range":[7,16]},"property":{"type":"Identifier","name":"calculateTimeDiffInMilliseconds","range":[17,48]},"computed":false,"range":[7,48]},"arguments":[{"type":"Identifier","name":"startMs","range":[49,56]}],"range":[7,57]},"right":{"type":"NumericLiteral","value":10,"range":[61,63]},"range":[7,63]}],"range":[0,64]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"dateUtils","range":[7,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"calculateTimeDiffInMilliseconds","range":[17,48]},{"type":{"label":"("},"range":[48,49]},{"type":{"label":"name"},"value":"startMs","range":[49,56]},{"type":{"label":")"},"range":[56,57]},{"type":{"label":"</>"},"value":">=","range":[58,60]},{"type":{"label":"num"},"value":10,"range":[61,63]},{"type":{"label":")"},"range":[63,64]}]',
    visitorKeys: _powerAssertVisitorKeys
  }));
});
//# sourceMappingURL=..\node_modules\.cache\ava\fb8f9e30fe322b8fa528f9568534dd81.js.map