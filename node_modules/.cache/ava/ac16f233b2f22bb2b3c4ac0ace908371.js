...
myModule.__set__("sftp", sftpMock);

(0, _ava2.default)('save File On SFTP Server', t => {
    myModule.saveFileOnSFTPServer(null, null, myModule.sftpConnectionTestParameters());
    t.true(true);
});

(0, _ava2.default)('read File From SFTP Server', t => {
    myModule.readFileFromSFTPServer(null, myModule.sftpConnectionTestParameters(), new function (a) {}());
    t.true(true);
});
//# sourceMappingURL=..\node_modules\.cache\ava\ac16f233b2f22bb2b3c4ac0ace908371.js.map