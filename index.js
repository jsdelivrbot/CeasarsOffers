...
router.route('/offers').post(function(req, res) {
        res.json({ message: 'You have done successful offer post call with following body request : ' + req  });
    }
);
...
router.route('/contacts').post(function(req, res) {
        res.json({ message: 'You have done successful contacts post call with following body request : ' + req });
    }
);
